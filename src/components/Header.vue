...
.nav-links a { color: #334155; text-decoration: none; padding: 0.48rem 0.85rem; border-radius: 999px; transition: all 0.2s ease; }
.nav-links a:hover, .nav-links a.router-link-active { color: #1e3a8a; background: #e9efff; }
